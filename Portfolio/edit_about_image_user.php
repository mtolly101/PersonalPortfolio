...
<head>
    <meta charset="UTF-8">
    <title>Edit About Image (User) • Personal Portfolio</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>

<div class="container">
    <h2>Edit Your About Me Image</h2>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($conn->query($sql) === TRUE) {
            header("Location: user_about.php"); // Back to user page
            exit();
        } else {
    ...
    <br><a href="user_about.php">Back to About</a>
