...
<div id="services">
    <div class="container">
        ...
        <?php
            ...
            $sql = "SELECT * FROM teaching WHERE user_id = 1";
            ...
            if ($result && $result->num_rows > 0) {
                ...
                if (isset($_SESSION["userlevel"]) && $_SESSION["userlevel"] == 1) {
                    echo "
                        ...
                        <a href='delete.php?table=teaching&id={$row['id']}' onclick=\"return confirm('Delete this item?');\">Delete</a>
                    ";
                }
            ...
            if (isset($_SESSION["userlevel"]) && $_SESSION["userlevel"] == 1) {
                echo "<br><a href='add_teaching_admin.php?table=teaching' class='btn'>+ Add New Teaching</a>";
            }
